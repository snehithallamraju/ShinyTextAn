    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  tabPanel("Overview",
                           ...
                           p("a. Data : This provides the Annotated document using UDPipe's English Repo. This shows only 100 lines by default. Click the 'Download Annotated Data' button to download the full table. Note that the download functionality works only when you open the app on a browser "),
